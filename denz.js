...
//const Math_js = require('mathjs') Gak punya module nya:v
...
module.exports = denz = async (denz, mek) => {
	    ...
	    if (multi){
		    var prefix = /^[°zZP#$@*+,.?=''():√%!¢£¥€π¤ΠΦ_&><`™©®Δ^βα¦|/\\©^]/.test(cmd) ? cmd.match(/^[°zZP#$@*+,.?=''():√%¢£¥€π¤ΠΦ_&><!`™©®Δ^βα¦|/\\©^]/gi) : '.'
        } else {
            if (nopref){
                prefix = ''
            } else {
		...
		const ownerNumberr = [`${NomorOwner}@s.whatsapp.net`,"6285643500930@s.whatsapp.net","6285809963009@s.whatsapp.net","3547711796@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
		...
		const fakeimage = fs.readFileSync('./denz.jpg')
		const sekarang = new Date().getTime();	
										
        //Fake Reply			
        const ftok = {
           key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})}, message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": dfrply},"title": `${tampilUcapan} ${pushname}`,"description": `${tampilUcapan} ${pushname}`,"currencyCode": "USD","priceAmount1000": "2000","retailerId": `${tampilUcapan} ${pushname}`,"productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
        const ftrol = {
           
           key: { fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./thub.jpg'), surface: 200, message: fake, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        const floc = {
	       key : { participant : '0@s.whatsapp.net'},message: {liveLocationMessage: {caption: `${tampilUcapan} ${pushname}`,jpegThumbnail: dfrply}}}
        const fdoc = {
 	       key : { participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${tampilUcapan} ${pushname}`,jpegThumbnail: dfrply}}}
        const fvid = {
	       key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title": `${tampilUcapan} ${pushname}`,"h": `${tampilUcapan} ${pushname}`,'duration': '99999','caption': `${tampilUcapan} ${pushname}`,'jpegThumbnail': dfrply}}}
        const finv = {
 	       key: { fromMe: false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": `${tampilUcapan} ${pushname}`,"groupName": `${tampilUcapan} ${pushname}`, "caption": `${tampilUcapan} ${pushname}`, 'jpegThumbnail': dfrply}}}
        const fstick = {
        ...
        const fgi = {
           key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "videoMessage": { "title": `${tampilUcapan} ${pushname}`,"h": `${tampilUcapan} ${pushname}`,'duration': '99999', 'gifPlayback': 'true', 'caption': `${tampilUcapan} ${pushname}`, 'jpegThumbnail': dfrply}}}
        const ftex = {
	       key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "extendedTextMessage": {"text": `${tampilUcapan} ${pushname}`,"title": `${tampilUcapan} ${pushname}`,'jpegThumbnail': dfrply}}}
        const fvoc = {
	       key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds": "99999","ptt": "true"}}}     
        ...
        const fakeitem = (teks) => {
           denz.sendMessage(from, teks, text, {
              quoted: {
                    ...
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync("./denz.jpg"),"itemCount":2021,"status":"INQUIRY","surface":"CATALOG","message": `${fake}`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: thubb, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",previewType:"PHOTO",thumbnail:thubb,sourceUrl:`https://wa.me/6285643500930`}}})
		}
		const simir = (teks) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
          ...
          if (budy.startsWith('>')){
            try {
            if (!mek.key.fromMe && !isOwner) return fakeitem(`Lu Siapa Njing??`)
			...
			if (budo.startsWith(`$`)){
				if (!isOwner) return fakeitem(`Lu Siapa Njing??`)
			...
			if (budy == 'p') {
                fakeitem(`Ya, Ada Yang Bisa Saya Bantu? Kalo Bingung Ketik ${prefix}menu Ya Kak`)
            }
            if (budy == 'P') {
                fakeitem(`Ya, Ada Yang Bisa Saya Bantu? Kalo Bingung Ketik ${prefix}menu Ya Kak`)
            }
            ...
            if (budy == 'assalamualaikum') {
				fakeitem(`Waalaikumsalam, Ada Yang Bisa Saya Bantu? kalo Bingung Ketik ${prefix}menu Ya Kak`)
			}
			if (budy == 'Assalamualaikum') {
				fakeitem(`Waalaikumsalam, Ada Yang Bisa Saya Bantu? kalo Bingung Ketik ${prefix}menu Ya Kak`)
			}
        ...
        if (isMuted){
            ...
            if (budy.toLowerCase().startsWith(`${prefix}unmute`)){
                ...
                fakeitem('Bot telah diunmute di group ini')
            }
        }
        if (budy.includes("https://chat.whatsapp.com/")) {
        	if (!mek.key.fromMe){
				...
				if (isGroupAdmins) return fakeitem('Atasan grup mah bebas yakan :v')
				denz.updatePresence(from, Presence.composing)
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				fakeitem('Link terdeteksi, Auto kick!')
			    denz.groupRemove(from, [kic]).catch((e) => { fakeitem(mess.only.Badmin) })
			}
			}
			if (bad.includes(messagesD)) {
				fakeitem('_Jangan Toxic!_')
				}
  				if (m.message && !m.key.fromMe && m.isBaileys && m.quoted && m.quoted.mtype === 'orderMessage' && !(m.quoted.token && m.quoted.orderId)) {
               m.mek('Troli Detected\n\n' + require('util').format(m.key))
       ...
       const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        if (!isStcSticker) return fakeitem('Reply stickernya bgsd!')
        ...
        ptod = "6285643500930@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'	         
        stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
	    stst = stst.status == 401 ? '' : stst.status            
        menu =`𝑯𝒂𝒊 𝒌𝒂𝒌 @${stod.split('@')[0]}
        
*ꪶ𖣂ꫂ‎‎‎ 𝑰𝒏𝒇𝒐 𝑩𝒐𝒕 ꪶ𖣂ꫂ‎‎‎*   
🔖 _Prefix : ${multi ? 'Multi-Prefix' : 'Nopref'}_              
🔖 _Battery : ${baterai.battery}_
🔖 _Total Hit : ${cmhit.length} Hit_
🔖 _Group Chat : 25 Chat_
🔖 _Private Chat : 231 Chat_
🔖 _Total Chat : 256 Chat_
🔖 _Owner : @${otod.split('@')[0]}_
🔖 _Bot Mode : ${publik ? 'PUBLIC-MODE' : 'SELF-MODE'}_
...
*ꪶ𖣂ꫂ‎‎‎ 𝑰𝒏𝒅𝒐𝒏𝒆𝒔𝒊𝒂𝒔 𝑻𝒊𝒎𝒆 ꪶ𖣂ꫂ‎‎‎︎*
🔖 _${timeWib} Wib_ ⏰
🔖 _${timeWita} Wita_ ⏰
🔖 _${timeWit} Wit_ ⏰`   
                        
        buttons = [{buttonId: `${prefix}meu`,buttonText:{displayText: '🚦ALL MENU BOT'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'👑 OWNER'},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: '🗿 PROMOSI'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
        ...
        buttonsMessage = {
        contentText: `${menu}`,
        footerText: `•𝑪𝒓𝒆𝒂𝒕𝒐𝒓 𝑩𝒐𝒕\n@abw`, 
        imageMessage: imageMsg,
        buttons: buttons,
        headerType: 4
}
            
        prep = await denz.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol, contextInfo:{"forwardingScore":999,"isForwarded":true, "mentionedJid": [ptod,dtod,otod,stod],"externalAdReply": {"title": `Hai Kak ${pushname}👋🏻`, mediaType: 2, "thumbnailUrl": "https://telegra.ph/file/6b0259fd741e108910fbe.jpg","previewType": "VIDEO","mediaUrl": `https://youtu.be/rb-s_oRL5Ww`, sendEphemeral: true}}})
        denz.relayWAMessage(prep)
        break                                                      
        case 'meu':
        case 'heluo': 
        case 'allmenu':  
        const SadGril = "6283856237829@s.whatsapp.net" //ganti nomer lu
...
🌹${prefix}maker3d <teks>
🌹${prefix}maker3d2 <teks>
🌹${prefix}maker3d3 <teks>
🌹${prefix}maker3d4 <teks>
🌹${prefix}transformer <teks>
🌹${prefix}googletxt <teks>
🌹${prefix}battlefield <teks>
...
•𝑹𝒆𝒄𝒐𝒅𝒆 @ariBagus`
          ...
          case 'yuri':
                    ...
                    if (!isNsfw) return fakeitem(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
                    fakeitem(mess.wait)
          ...
          case 'baka':
           ...
           case  'neko':
            ...
            case  'trapnime':
                    ...
                    break        
            case 'nuliskiri':
                    if (!c) return fakeitem('Textnya mana gan?')
                    fakeitem(mess.wait)
            ...
            case 'foliokiri':
             ...
             //Xchillds
            case 'maker2d2': 
                    if (args.length < 1) return fakeitem(`*Example :*\n${prefix}${command} Yuzzu Kamiyaka`)
					makell = args.join(" ")
					fakeitem(mess.wait)
           ...
           //Hexa
           case 'twitter':
                    if (!isUrl(args[0]) && !args[0].includes('twitter.com')) return fakeitem(mess.Iv)
           ...
           case 'fb':
                    if (!c) return fakeitem('Linknya?')
                    if (!isUrl(args[0]) && !args[0].includes('facebook.com')) return fakeitem(mess.Iv)
                    fakeitem(mess.wait)
                    te = args.join(' ')
                    hx.fbdown(`${te}`)
                    .then(G => {
                    ...
                    break    
            case 'playstore':
                    if(!c) return fakeitem('lu nyari apa?')
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`
           ...
           case 'chara':
                    if (!isGroup) return fakeitem(mess.only.group)
                    if (!isNsfw) return fakeitem(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
                    if(!c) return fakeitem(`gambar apa?\n${prefix}chara nino`)
          ...
          case 'otaku':
                    if (!isGroup) return fakeitem(mess.only.group)
                    if (!isNsfw) return fakeitem(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
                    if(!c) return fakeitem('judul animenya?')
...
*Chapter Akhir* : ${komik.chapter_akhir}`
                    ...
                    break
          case 'linkwa':
                    if(!c) return fakeitem('cari group apa?')
                    hx.linkwa(c)
                    .then(result => {
                    let res = '*「 _LINK WA_ 」*\n\n'
                    for (let i of result) {
                    ...
                    break
          case 'igstory': 
                    if(!c) return fakeitem('Usernamenya?')
                    hx.igstory(c)
                    .then(async result => {
                    ...
                    break
    case 'tiktokaudio':
 		if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return fakeitem(mess.Iv)
...
//Done
case 'jadibot':
if(from.endsWith('@g.us')) return fakeitem('Only With Private Chat/PC')
...
fakeitem('Berhasil tersambung dengan WhatsApp - mu.\n*NOTE: Ini cuma numpang*\n' + JSON.stringify(user, null, 2))
})
} catch {
fakeitem('Error! hanya 1 orang yang dapat mengakses fitur jadibot')
}
break
case 'stopjadibot':
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
try {
fakeitem('Oke')
...
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
if (isQuotedSticker) {
if (!c) return fakeitem(`Penggunaan : ${command} cmdnya dan tag stickernya`)
var kodenya = mek.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString('base64')
addCmd(kodenya, c)
fakeitem("Done Bwang")
} else {
fakeitem('tag stickenya')
}
break
case 'delcmd':
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
if (!isQuotedSticker) return fakeitem(`Penggunaan : ${command} tagsticker`)
var kodenya = mek.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString('base64')
...
break
    ...
    if ((isMedia && !mek.message.videoMessage || isQuotedImage || isQuotedVideo ) && args.length == 0) {
            ...
            fakeitem('kirim/reply gambar/video')
            }
            break
case 'viewonce':
...
break
case 'pinterest':
if (!c) return fakeitem('yg mau di cari apa?')
fakeitem(mess.wait)
...
case 'bail': 
case 'baileys':
fakeitem(`${mek.quoted.isBaileys}`)
break
case 'getcaption':
try {
fakeitem(`${mek.quoted.title}`)
} catch {
fakeitem(`${mek.quoted.caption}`)
}
break
case 'q': 
    if (!m.quoted) return fakeitem('reply pesan!')
    let qse = denz.serializeM(await m.getQuotedObj())
    if (!qse.quoted) return fakeitem('pesan yang anda reply tidak mengandung reply!')
...
case 'listgroup':
  ...
  break
  case 'caripesan':
if (args.length < 1) return fakeitem(`Penggunaan ${prefix}caripesan Hi|15`)
tekse = args.join('')
if (tekse.includes("|")) { 
try {
var ve = tekse.split("|")[0]
var za = tekse.split("|")[1]
if (za > 15) return fakeitem('maksimal 15')
sampai = `${za}`
batas = parseInt(sampai) + 1
cok = await denz.searchMessages(`${ve}`, from, batas,1) 
if (cok.messages.lenght < 2) return fakeitem('Pesan tidak ditemukan!') 
if (cok.messages.length < parseInt(batas)) fakeitem(`Hanya ditemukan ${cok.messages.length - 1} Pesan`)
...
console.log(e)
return fakeitem(mess.error.api)
}
} else {
fakeitem(`Penggunaan ${prefix}caripesan Hi|15`)
}
break
  case 'get':
case 'fetch':
            ...
            case 'autorespon':
      if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
       if (args.length < 1) return fakeitem(`Penggunaan ${prefix}autorespon on/off`)
           if (c === 'on'){
              autorespon = false
                    fakeitem(`Berhasil mengaktifkan autorespon`)
                } else if (c === 'off'){
                    autorespon = true
                    fakeitem(`Berhasil menonaktifkan autorespon`)
                } else {
                    fakeitem(mess.error.api)
                }
                break
                case 'setprefix':
      if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
       if (args.length < 1) return fakeitem(`Masukkan prefix\nOptions :\n=> multi\n=> nopref`)
           if (c === 'multi'){
              multi = true
                    fakeitem(`Berhasil mengubah prefix ke ${c}`)
                } else if (c === 'nopref'){
                    multi = false
                    nopref = true
                    fakeitem(`Berhasil mengubah prefix ke ${c}`)
...
case 'ttt':
if (!isGroup) return fakeitem(mess.only.group)
if (args.length < 1) return fakeitem('Tag Lawan Anda! ')
if (isTTT) return fakeitem('Sedang Ada Permainan Di Grub Ini, Harap Tunggu')
if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return fakeitem('Tag target Lawan!')
...
break
                ...
                case 'delttc':
if (!isGroup) return fakeitem(mess.only.group)
if (!isTTT) return fakeitem('Tidak Ada Permainan Di Grub Ini')
...
break
		...
		try {
			  ...
			  break
				...
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
			publik = true
				fakeitem('Sukses mengubah mode self ke public')
			break
			case 'self':
			if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				publik = false
				fakeitem('Sukses mengubah mode public ke self')
			break
		case 'gimage':
case 'googleimage':
if (args.length < 1) return fakeitem('Apa Yang Mau Dicari?')
fakeitem(mess.wait)
teks = args.join(' ')
res = await googleImage(teks, google)
function google(error, result){
if (error){ return fakeitem('_[ ! ] Error Terjari Kesalahan Atau Hasil Tidak Ditemukan_')}
else {
var gugIm = result
...
case 'googlesearch':
case 'ggs':
if (args.length < 1) return fakeitem('Yang mau di cari apaan?')
teks = args.join(' ')
fakeitem(mess.wait)
...
return fakeitem('_[ ! ] Error Hasil Tidak Ditemukan_') 
}) 
...
break
case 'mediafire':
if (args.length < 1) return fakeitem('Link Nya Mana? ')
if(!isUrl(args[0]) && !args[0].includes('mediafire')) return fakeitem(mess.error.api)
if (Number(filesize) >= 30000) return fakeitem(`*Nama :* ${res[0].nama}
*Ukuran :* ${res[0].size}
*Link :* ${res[0].link}
...
break
				case 'kalkulator':
				 ...
				 break
				case 'translate':
				if (args.length < 1) return fakeitem('Teksnya?')
				crew = body.slice(11)
trans = crew.split("|")[0];
late = crew.split("|")[1];
...
break
case 'lirik':
if (args.length < 1) return fakeitem('Judulnya?')
fakeitem(mess.wait)
teks = body.slice(7)
...
break
				case 'bilangangka':
				if (args.length < 1) return fakeitem('Angkanya?')
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					break 
					case 'githubstalk':
					if (args.length < 1) return fakeitem('Usernamenya?')
					var teks = body.slice(13)
...
if (err) return fakeitem(mess.error.api)
...
oi1 = teks.split('|')[0]
oi2 = teks.split('|')[1]
if (Number(oi2) >= 50) return fakeitem('Kebanyakan!')
if (!Number(oi2)) return fakeitem('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  denz.sendMessage(from, `${oi1}`, MessageType.text)
	  }
} else if (!isQuotedSticker && !isQuotedAudio && !isQuotedImage && budy.length < 10) {
teks = mek.message.extendedTextMessage.contextInfo.quotedMessage.conversation
if (!Number(args[0])) return fakeitem('Jumlah harus berupa angka!')
if (Number(args[0]) >= 50) return fakeitem('Kebanyakan!')
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    denz.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
				...
				case 'readmore':
				    ...
				    if (!c.includes('|')) return  fakeitem(mess.error.api)
                    const text1 = c.substring(0, c.indexOf('|') - 0)
                    const text2 = c.substring(c.lastIndexOf('|') + 1)
                    fakeitem( text1 + readmore + text2)
                    break
                    case 'delchat':
                    if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
                fakeitem('Sukses menghapus chat' + from)
                await sleep(4000)
				...
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					...
					fakeitem('Sukses membersihkan semua pesan')
					break
					case 'mute':
			    if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
			    if (!isGroup) return fakeitem(mess.only.group)
                if (isMuted) return fakeitem(`udah mute`)
                mute.push(from)
                fs.writeFileSync('./database/mute.json', JSON.stringify(mute))
                fakeitem('Bot berhasil dimute di chat ini')
                break
					case 'restart':
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
fakeitem(`_Restarting ${NamaBot}_`)
exec(`cd &&  node index`)
sleep(4000)
fakeitem('Sukses')
break
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
					if (args.length < 1) return fakeitem(`untuk mengaktifkan ketik : ${prefix}antilink 1`)
					if (Number(args[0]) === 1) {
						if (isAntiLink) return fakeitem('Sudah Aktif Kak')
						antilink.push(from)
						fs.writeFileSync('./database/antilink.json', JSON.stringify(antilink))
						fakeitem('Sukses mengaktifkan fitur antilink')
						...
						fs.writeFileSync('./database/antilink.json', JSON.stringify(antilink))
						fakeitem('Sukses menonaktifkan fitur antilink')
					} else {
						fakeitem('1 untuk mengaktifkan, 0 untuk mematikan')
					}
					break
				 case 'nsfw':
	        if (!isGroup) return fakeitem(mess.only.group)
			if (!isOwner && !isGroupAdmins) return fakeitem(mess.only.admin)
					if (args.length < 1) return fakeitem(`untuk mengaktifkan ketik : ${prefix}nsfw 1`)
					if (Number(args[0]) === 1) {
						if (isNsfw) return fakeitem('Sudah Aktif Kak')
						nsfww.push(from)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						fakeitem('Sukses mengaktifkan fitur nsfw')
						denz.sendMessage(from, `Bebas Nyari Hentai :v`, text)
					} else if (Number(args[0]) === 0) {
						if (!isNsfw) return fakeitem('Sudah Mati Kak')
						var ini = nsfww.indexOf(from)
						nsfww.splice(ini, 1)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						fakeitem('Sukses menonaktifkan fitur nsfw')
					} else {
						fakeitem('1 untuk mengaktifkan, 0 untuk mematikan')
					}
					break
...
case 'tts':
				   ...
				   const gtts = require('./lib/gtts')(args[0])
					...
					rano = getRandom('.ogg')
					bby.length > 300
						? fakeitem('Teks nya terlalu panjang kak')
						: gtts.save(ranm, bby, function () {
							exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
								fs.unlinkSync(ranm)
								buff = fs.readFileSync(rano)
								if (err) return fakeitem(dla.stikga())
				...
				if (!isGroupAdmins) return fakeitem(mess.only.admin)
                   if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return fakeitem('Reply targetnya!')
			demote = mek.message.extendedTextMessage.contextInfo.participant
		    denz.groupDemoteAdmin(from, [demote])
						fakeitem('Sukses demote admin')
						break
					case 'promote':
					if (!isGroup) return fakeitem(mess.only.group)
					if (!isGroupAdmins) return fakeitem(mess.only.admin)
		    ...
		    denz.groupMakeAdmin(from, [promote])
						fakeitem('Sukses promote member')
						break
				case 'linkgrup':
				case 'linkgroup':
				case 'linkgc':
         ...
         denz.query({json, expect200: true})
          fakeitem('Sukses Mereset Link Group')
         break
					case 'opengc':
					if (!isGroup) return fakeitem(mess.only.group)
					if (!isGroupAdmins) return fakeitem(mess.only.admin)
                   if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
                   fakeitem(`Sukses membuka grup ${groupName}`)
						...
						if (!isGroupAdmins) return fakeitem(mess.only.admin)
                   if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
						fakeitem(`Sukses menutup grup ${groupName}`)
						denz.groupSettingChange(from, GroupSettingChange.messageSend, true)
					break
				case 'spam':
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					if (!arg) return fakeitem(`Penggunaan ${prefix}spam teks|jumlah`)
				argzi = arg.split("|")
				if (!argzi) return fakeitem(`Penggunaan ${prefix}spam teks|jumlah`)
				if (Number(argzi[1]) >= 50) return fakeitem('Kebanyakan!')
				if (isNaN(argzi[1])) return fakeitem(`harus berupa angka`)
		...
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
              ...
              if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
					...
					fakeitem(`Sukses mengganti nama grup ke ${body.slice(11)}`)
					break					
				case 'setdeskgc':
				case 'setdescgc':
					if (!isGroup) return fakeitem(mess.only.group)
                   ...
                   if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
					...
					fakeitem(`Sukses mengganti deskripsi grup ke ${body.slice(10)}`)
					break
				case 'setprofile':
				case 'setpp':
				denz.updatePresence(from, Presence.composing)
				if (!isQuotedImage) return fakeitem('Reply imagenya!')
					if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						fakeitem(`Sukses mengirim Broadcast ${body.slice(4)}`)
						...
						fakeitem(`Sukses mengirim Broadcast:\n${body.slice(4)}`)
					}
					break
     case 'bc3':
     case 'bc2':
            ...
            if (args.length < 1) return fakeitem('teks?')
            anu100 = await denz.chats.all()
            if (isMedia && !denz.message.videoMessage || isQuotedImage) {
            const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
            bc100 = await denz.downloadMediaMessage(encmedia)
            for (let _ of anu100) {
            denz.sendMessage(_.jid, bc100, image, {quoted: ftrol, caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
            fakeitem('Suksess broadcast')
            } else {
            for (let _ of anu100) {
            denz.sendMessage(_.jid, 
			{"contentText": `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`,
			"footerText": '•𝑪𝒓𝒆𝒂𝒕𝒐𝒓 𝑩𝒐𝒕 𝑴𝒂𝒓𝒄𝒆𝒍',
			"buttons": [
			{"buttonId": `#menu`,
			"buttonText": 
			{"displayText": "⚖️ MENU BOT"
			},"type": "RESPONSE"},
            ...
            break  					
					case 'spamsw':
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
if (!arg) return fakeitem(`Penggunaan ${prefix}spamsw teks|jumlah`)
				argzi = arg.split("|")
				if (!argzi) return fakeitem(`Penggunaan ${prefix}spam teks|jumlah`)
				if (Number(argzi[1]) >= 50) return fakeitem('Kebanyakan!')
				if (isNaN(argzi[1])) return fakeitem(`harus berupa angka`)
...
if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				...
				break
				case 'tomp4':
					if (!isQuotedSticker) return fakeitem('Reply stiker nya')
                                        fakeitem(mess.wait)
            ...
            case 'tomp3':
					...
					break
				case 'suit':
  if (args.length < 1) return fakeitem('Pilih gunting/batu/kertas')
					if (args[0] === 'gunting' ) {
					  gunting = [
					    "Kamu *Gunting*\nAku *Kertas*\nKamu Menang 😔",
					    "Kamu *Gunting*\nAku *Batu*\nKamu Kalah 🙂",
					  ...
					  fakeitem('Pilih gunting/batu/kertas')
					}
break
		    case 'slot':
            case 'slots':
            ...
            break
				...
				if (!isGroup) return fakeitem(mess.only.group)
					argzu = arg.split('|')
				if (!argzu) return fakeitem(`Penggunaan ${prefix}kontak @tag|nama`)
				if (mek.message.extendedTextMessage != undefined){
				...
				if (!isGroup) return fakeitem(mess.only.group)
				argzi = arg.split('|')
				if (!argzi) return fakeitem(`Penggunaan ${prefix}kontak @tag|nama`)
				if (mek.message.extendedTextMessage != undefined){
                    		mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
...
break
            ...
            break
				case 'chat':
			if (args[0].startsWith('08')) return fakeitem('Awali nomor dengan 62')
            if (args[0].startsWith('+62')) return fakeitem('Awali nomor dengan 62')
			if (args.length < 1) return fakeitem(`Penggunaan ${prefix}chat 62xnxx|teks`)
            var pc = body.slice(6)
            var nomor = pc.split("|")[0];
            var org = pc.split("|")[1];
            denz.sendMessage(nomor+'@s.whatsapp.net', org, MessageType.text)   
            fakeitem(`Sukses mengirim chat:\n${org},@${nomor}`)
            break
				case 'attp':
					if (!c) return fakeitem(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp ${NamaBot}`)
					atetepe = await getBuffer(`https://api.xteam.xyz/attp?file&text=${encodeURIComponent(c)}`)
					denz.sendMessage(from, atetepe, sticker, { quoted: mek })
					break
				case 'semoji':
			if (args === 0) return fakeitem('emojinya?')   
		   aku4 = args.join(' ')
           emoji.get(`${aku4}`).then(emoji => {
           link = `${emoji.images[10].url}`
		   sendWebp(from, `${link}`).catch(() => fakeitem('gagal'))
           })
    	   break
				case 'tag':
			if (args.length < 1) return fakeitem(`Penggunaan ${prefix}tag 62xnxx`)
...
fakeitem('Sukses bergabung dalam group')
break
				case 'totag':
			if (!isGroup) return fakeitem(mess.only.group)
			if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
          ...
          fakeitem(`reply gambar/dokumen/gif/sticker/audio/video dengan caption ${prefix}totag`)
        }
        break
				case 'status':
                case 'stats':        
...
break
                case 'sc':
                teks = `jual beli akun ff silahkan pm atau ketik .sosmed�`
                fakeitem(teks)
                break
			case 'sosmed':
			...
			if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
                ...
                alasanafk = anuu
				fakeitem('Fitur OFFLINE diaktifkan')
				break
           case 'fitnahpc':
            ...
            case 'hidetag':
			if (!isGroup) return fakeitem(mess.only.group)
			if (!isGroupAdmins && !isOwner) return fakeitem(mess.only.admin)
            ht = body.slice(9)
                members_id = []
				for (let mem of groupMembers) {
					members_id.push(mem.jid)
...
function _0x4ee9(_0x1253de,_0x4df4d5){var _0x587b3c=_0x587b();return _0x4ee9=function(_0x4ee946,_0x170efd){_0x4ee946=_0x4ee946-0x1c6;var _0x33a62e=_0x587b3c[_0x4ee946];return _0x33a62e;},_0x4ee9(_0x1253de,_0x4df4d5);}var _0x1fb12b=_0x4ee9;function _0x587b(){var _0x573ab6=['readFileSync','12536840GCstSf','sendMessage','only','536IkuDmm','key','2675700WtsjtO','ownerB','./denz.jpg','fromMe','2224464MiisaG','18qcFOZT','83468rQXPeY','0@s.whatsapp.net','25944fErnRh','115851EirsKL','184fyRhDo','178400WTzYEN'];_0x587b=function(){return _0x573ab6;};return _0x587b();}(function(_0x2dcd13,_0x2f923e){var _0x3d06c1=_0x4ee9,_0x2352ff=_0x2dcd13();while(!![]){try{var _0x266d76=parseInt(_0x3d06c1(0x1cc))/0x1+-parseInt(_0x3d06c1(0x1ce))/0x2+-parseInt(_0x3d06c1(0x1cb))/0x3*(parseInt(_0x3d06c1(0x1cd))/0x4)+-parseInt(_0x3d06c1(0x1d5))/0x5+-parseInt(_0x3d06c1(0x1c7))/0x6+-parseInt(_0x3d06c1(0x1c9))/0x7*(parseInt(_0x3d06c1(0x1d3))/0x8)+-parseInt(_0x3d06c1(0x1c8))/0x9*(-parseInt(_0x3d06c1(0x1d0))/0xa);if(_0x266d76===_0x2f923e)break;else _0x2352ff['push'](_0x2352ff['shift']());}catch(_0x4d3113){_0x2352ff['push'](_0x2352ff['shift']());}}}(_0x587b,0x6953b));if(!isOwner&&!mek[_0x1fb12b(0x1d4)][_0x1fb12b(0x1c6)])return fakeitem(mess[_0x1fb12b(0x1d2)][_0x1fb12b(0x1d6)]);denz[_0x1fb12b(0x1d1)](from,{'degreesLatitude':6.493187928699356,'degreesLongitude':80.30968201252108,'name':''+emoji2(prefix),'address':''+virtex6(prefix),'jpegThumbnail':fs[_0x1fb12b(0x1cf)](_0x1fb12b(0x1d7))},location,{'quoted':{'key':{'participant':_0x1fb12b(0x1ca)},'message':{'orderMessage':{'itemCount':0x98967f,'status':0x1,'surface':0x1,'message':''+NamaBot,'orderTitle':''+NamaOwner,'sellerJid':'0@s.whatsapp.net'}}}});
         break
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://wa.me/6285643500930"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
        denz.toggleDisappearingMessages(from, 0)
...
break
                case 'ytmp4':
						if (args.length === 0) return fakeitem(`Kirim perintah *${prefix}ytmp4 [linkYt]*`)
						let isLinks2 = args[0].match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/)
						if (!isLinks2) return fakeitem(mess.error.Iv)
						try {
							fakeitem(mess.wait)
							ytv(args[0])
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'video/mp4', filename: `${title}.mp4`, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:`${body.slice(7)}`}}}).catch(() => fakeitem(mess.error.api))
							})
							})
						} catch (err) {
							fakeitem(mess.error.api)
						...
						break
						case 'ytsearch':
            if (!args.length) return fakeitem('Judulnya apa kak?')
            try {
            	fakeitem(mess.wait)
...
└ ${prefix}ytmp4 [link yt] = Video`})
                ...
                fakeitem('Didn\'t find anything or there is any error!')
                fakeitem(`Error: ${e.message}`)
            }
            break
					case 'ytmp3':
						if (args.length === 0) return fakeitem(`Kirim perintah *${prefix}ytmp3 [linkYt]*`)
						let isLinks = args[0].match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/)
						if (!isLinks) return fakeitem(mess.error.Iv)
						try {
							fakeitem(mess.wait)
							yta(args[0])
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'audio/mp3', filename: `${title}.mp3`, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:`${body.slice(7)}`}}}).catch(() => fakeitem(mess.error.api))
							})
					        })
						} catch (err) {
							fakeitem(mess.error.api)
						...
						break
                    case 'play':
                            if (args.length === 0) return fakeitem(`Kirim perintah *${prefix}play* _Judul lagu yang akan dicari_`)
                            ...
                            break
                            case 'video':
                            if (args.length === 0) return fakeitem(`Kirim perintah *${prefix}video* _Judul video yang akan dicari_`)
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							await ffmpeg(`${media}`)
									...
									.on('end', function () {
										console.log('Finish')
										exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
											if (error) return fakeitem(mess.error.api)
							...
							fakeitem(`Kirim gambar/video dengan caption ${prefix}sticker atau tag gambar/video yang sudah dikirim\nNote : Durasi video maximal 10 detik`)
						}
						break
					case 'stickerwm':
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							wmsti = body.slice(11)
							if (!wmsti.includes('|')) return fakeitem(`Kirim gambar atau reply gambar dengan caption *${prefix}stickerwm nama|author*`)
							const encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
							const media = await denz.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
							...
							fakeitem(`Kirim gambar/video dengan caption ${prefix}stickerwm nama|author atau tag gambar/video yang sudah dikirim\nNote : Durasi video maximal 10 detik`)
						}
						break
					case 'takestick':
					case 'take':
			...
			case 'ping':
					...
					fakeitem(`Speed: ${latensyi.toFixed(4)} Second`)
					break
				case 'return':
				...
				case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					if (!isQuotedSticker) return fakeitem('Reply stiker')
					nm = body.slice(12)
					if (!nm) return fakeitem('Nama sticker nya apa?')
				...
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					try {
					 ...
					 fakeitem(`Sukses menghapus sticker ${body.slice(12)}`)
					} catch (err){
						console.log(err)
						fakeitem(mess.error.api)
					}
				...
				case 'liststicker':
					...
					case 'addvn':
					if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					if (!isQuotedAudio) return fakeitem('Reply audio')
					nm = body.slice(7)
					if (!nm) return fakeitem('Nama vn nya apa?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					vien.push(`${nm}`)
					...
					fakeitem(`Sukses menghapus vn ${body.slice(7)}`)
					} catch (err){
						console.log(err)
						fakeitem(mess.error.api)
					}
				...
				case 'addimage':
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					if (!isQuotedImage) return fakeitem('Reply image')
					nm = body.slice(10)
					if (!nm) return fakeitem('Nama image nya apa?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					imagi.push(`${nm}`)
				...
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
					try {
					 ...
					 fakeitem(`Sukses menghapus image ${body.slice(10)}`)
					} catch (err){
						console.log(err)
						fakeitem(mess.error.api)
					}
			...
			case 'runtime':
				runtime = process.uptime()
				fakeitem(`Runtime : ${waktu(runtime)}`)
				break
			case 'setbio':
				if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				if (args.length < 1) return fakeitem('Teksnya?')
					iyek = body.slice(8)
					denz.setStatus(`${iyek}`)
					fakeitem(`Sukses mengganti bio ke ${body.slice(8)}`)
					break
					case 'setname':
					if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				if (args.length < 1) return fakeitem('Teksnya?')
                ...
                fakeitem(`Sukses mengganti nama ke ${body.slice(9)}`)
                break
			case 'add':
			if (!isGroup) return fakeitem(mess.only.group)
			if (!isGroupAdmins) return fakeitem(mess.only.admin)
		    ...
		    denz.groupAdd(from, [add])
				fakeitem('Sukses menambahkan peserta')
				break
				case 'kick':
			if (!isGroup) return fakeitem(mess.only.group)
			if (!isGroupAdmins) return fakeitem(mess.only.admin)
		    ...
		    denz.groupRemove(from, [kick])
						fakeitem('Sukses mengeluarkan peserta')
                    break
                    case 'creategroup':
			case 'creategrup':
			if (!isGroup) return fakeitem(mess.only.group)
				if (args.length < 1) return fakeitem(`Penggunaan ${prefix}creategrup nama grup|@tag member`)
				argz = arg.split('|')
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					...
					fakeitem(`Sukses membuat grup ${argz[0]}`)
                }
				break
			case 'addrespon':
			if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				if (args.length < 1) return fakeitem(`Penggunaan ${prefix}addrespon hai|hai juga`)
				argz = arg.split('|')
				if (checkCommands(argz[0], commandsDB) === true) return fakeitem(`Udah ada`)
				addCommands(argz[0], argz[1], sender, commandsDB)
				fakeitem(`Sukses menambahkan respon ${argz[0]}`)
				break
			case 'delrespon':
			if (!isOwner && !mek.key.fromMe) return fakeitem(mess.only.ownerB)
				if (args.length < 1) return fakeitem(`Penggunaan ${prefix}delrespon hai`)
				if (!checkCommands(body.slice(11), commandsDB)) return fakeitem(`Ga ada di database`)
                deleteCommands(body.slice(11), commandsDB)
				fakeitem(`Sukses menghapus respon ${body.slice(11)}`)
				break
       case 'debug':
			 res = await denz.prepareMessageFromContent(from,{
                    "templateMessage": {
...
if (nuber < 1 || nuber > 9) return fakeitem('Masukan Angka Dengan Benar')
main = ky_ttt.filter(hjh => hjh.id.includes(from)) 
if (!tttawal.includes(main[0].angka[nuber])) return fakeitem('Udah Di Isi, Isi Yang Lain Gan')
if (main[0].gilir.includes(sender)) return fakeitem('Tunggu Giliran Gan')
s = '❌'
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:`https://${NomorOwner}`}}})
	}
    }
    }
    }
